...
std::vector<std::array<std::uint32_t, 2>> matchGlobally(const std::vector<KeyPoint*> &aKeypoints1, const std::vector<KeyPoint*> &aKeypoints2, const double aMinDistance) {
