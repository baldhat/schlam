...
int main()
{
    ...
    auto x = tft::Transformable3D(Eigen::Vector3d(1, 0, 0), "world");
    auto y = tft::Transformable3D(Eigen::Vector3d(0, 1, 0), "world");
    auto z = tft::Transformable3D(Eigen::Vector3d(0, 0, 1), "world");
    ...
    transforms.push_back(tft::RigidTransform3D("world", "frame1", rotZ180, Eigen::Vector3d(-1, -1, -1)));
    transforms.push_back(tft::RigidTransform3D("world", "frame2", rotZ90, Eigen::Vector3d(3, 0, 0)));
    transforms.push_back(tft::RigidTransform3D("world", "frame3", rotZ90, Eigen::Vector3d(1, 1, 1)));
